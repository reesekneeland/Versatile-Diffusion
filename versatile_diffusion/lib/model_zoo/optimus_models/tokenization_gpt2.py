...
class GPT2Tokenizer(PreTrainedTokenizer):
    ...
    def __init__(self, vocab_file, merges_file, errors='replace', unk_token="<|endoftext|>",
        ...
        subpackage = 'versatile_diffusion.lib.model_zoo.optimus_models.vocab'
        resource_name = osp.basename(vocab_file)
        with pkg_resources.open_text(subpackage, resource_name, encoding="utf-8") as f:
        ...
        resource_name = osp.basename(merges_file)
        with pkg_resources.open_text(subpackage, resource_name, encoding="utf-8") as f:
